...
Wij bouwden onze [online WebSocket tool](/nl/tools/websocket) omdat we een client nodig hadden die binaire data behandelt als een eersteklas burger, en niet als bijzaak.
...
- **Probeer de tool:** [Online WebSocket Client](/nl/tools/websocket)
