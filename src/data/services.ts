...
export const services: CardItem[] = [
  {
    ...
    description:
      "Delivering fast, reliable real-time performance for your embedded products.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Custom Linux platforms built for performance, flexibility, and scalability.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Seamless device-to-cloud communication for your connected ecosystem.",
    longDescription:
